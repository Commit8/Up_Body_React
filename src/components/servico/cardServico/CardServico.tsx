    ...
    <div className="relative p-0.5 bg-linear-to-r from-orange-400 to-pink-600 rounded-2xl">
      <div className="bg-gray-800 flex flex-col rounded-2xl overflow-hidden justify-between h-full">
        <div className="text-white">
          ...
          <hr className="h-0.5 border-0 bg-linear-to-r from-orange-400 to-pink-600" />
          <div className="p-6">
        ...
        {usuario.id === servico.usuario.id && (
          <div className="flex">
            <Link
              ...
              className="w-full text-white bg-linear-to-r from-[#4facfe] to-[#01d6e2] hover:from-[#4facfe] hover:to-[#00ffff] transition-all duration-300 flex items-center justify-center py-2"
            >
